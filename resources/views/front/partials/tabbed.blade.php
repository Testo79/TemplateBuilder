                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="mini_description" name="mini_description">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="GEO-PRODUCTNAME" class="form-control" id="alias" name="alias">
                            </div>
                            <div class="mb-3">
                                <label for="termes_legaux" class="form-label">Legal Terms</label>
                                <input type="text" value="Legal terms" class="form-control" id="termes_legaux" name="termes_legaux">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="9.99" class="form-control" id="nouveau_prix" name="nouveau_prix">
                            </div>
                            <div class="mb-3">
                                <label for="currency" class="form-label">Currency</label>
                                <input type="text" class="form-control" id="devise" name="devise" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="stock_restant" class="form-label">Remaining stock</label>
                                <input type="text" value="12% of remaining stock" class="form-control" id="stock_restant" name="stock_restant">
                            </div>
                            <div class="mb-3">
                                <label for="rating" class="form-label">Rating</label>
                                <input type="text" value="4.9/5 from more than 5,000 satisfied customers on Trustpilot" class="form-control" id="notation" name="notation">
                            </div>
                            <div class="mb-3">
                                <label for="garanties_retours" class="form-label">Warranties And Returns</label>
                                <input type="text" value="Waranties and returns" class="form-control" id="garanties_retours" name="garanties_retours">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="Exclusive Limited Offer" class="form-control" id="offer" name="offer">
                            </div>
                            <div class="mb-3">
                                <label for="customer_reviews" class="form-label">Customer Reviews</label>
                                <input type="text" value="Reviews from our customers" class="form-control" id="avis_clients" name="avis_clients">
                            </div>
                            <div class="mb-3">
                                <label for="more_about" class="form-label">More about</label>
                                <input type="text" value="More about" class="form-control" id="more_about" name="more_about">
                            </div>
                            <div class="mb-3">
                                <label for="confirmed_customer" class="form-label">Confirmed Customer</label>
                                <input type="text" value="Confirmed customer" class="form-control" id="confirmed_customer" name="confirmed_customer">
                            </div>
                            <div class="mb-3">
                                <label for="message" class="form-label">Message</label>
                                <input type="text" name="message" value="We exceptionally sell our products at wholesale prices, take advantage of it!" class="form-control" id="message">
                            </div>
                            <div class="mb-3">
                                <label for="description_cta" class="form-label">Description CTA</label>
                                <input type="text" value="Max of 1 order per household." class="form-control" name="cta_description" id="cta_description">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="policy" class="form-label">Policy</label>
                                <input type="text" value="Policy" class="form-control" id="politique" name="politique">
                            </div>
                            <div class="mb-3">
                                <label for="terms_conditions" class="form-label">Terms and Conditions</label>
                                <input type="text" value="Terms and conditions" class="form-control" id="termes_conditions" name="termes_conditions">
                            </div>
                            <div class="mb-3">
                                <label for="pub1" class="form-label">Pub 1</label>
                                <input type="text" value="Free Delivery" class="form-control" id="pub_1" name="pub_1">
                            </div>
                            <div class="mb-3">
                                <label for="pub2" class="form-label">Pub 2</label>
                                <input type="text" value="on all orders placed today!" class="form-control" id="pub_2" name="pub_2">
                            </div>
                            <div class="mb-3">
                                <label for="pub3" class="form-label">Pub 3</label>
                                <input type="text" value="Free refund for 60 days after purchase" class="form-control" id="pub_3" name="pub_3">
                            </div>
                            <div class="mb-3">
                                <label for="pub4" class="form-label">Pub 4</label>
                                <input type="text" value="Only a few are left in stock" class="form-control" id="pub_4" name="pub_4">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="Free delivery" class="form-control" id="livraison_gratuite" name="livraison_gratuite">
                            </div>
                            <div class="mb-3">
                                <label for="secure_payment" class="form-label">Secure Payment</label>
                                <input type="text" value="Secure Payment" class="form-control" id="paiement" name="paiement">
                            </div>
                            <div class="mb-3">
                                <label for="about" class="form-label">About</label>
                                <input type="text" value="About" class="form-control" id="about" name="about">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="4.9/5 Rating on Trustpilot" class="form-control" id="ratings_truspilot" name="ratings_truspilot">
                            </div>
                            <div class="mb-3">
                                <label for="temporary_offer" class="form-label">Temporary Offer</label>
                                <input type="text" value="Temporary & exceptional offer!" class="form-control" id="temporary_offer" name="temporary_offer">
                            </div>
                            <div class="mb-3">
                                <label for="cta_text" class="form-label">Text CTA</label>
                                <input type="text" value="Buy Now" class="form-control" id="cta_text" name="cta_text">
                            </div>
                            <div class="mb-3 ">
